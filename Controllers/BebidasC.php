...
$sql = "SELECT 
            ...
            dp.cantidad,
            p.fecha_hora,
            dp.comentario,      -- Agregar comentario a la consulta
            p.estado,
            p.tiempo_pedido
        FROM Pedidos p
        ...
        WHERE pr.categoria = 'bebidas' AND dp.estado = 'pendiente'
        ...
        if ($mesa_actual != $row["numero_mesa"]) {
            if ($mesa_actual != "") {
                echo "<div class='status'>
                        <form method='POST' class='finalizar-pedido'>
                            ...
                            <button type='submit' class='btn finished'>FINALIZADO</button> <!-- Cambiado a type='submit' -->
                        </form>
                      </div>
            ...
            echo "<div class='mesa-container'>
                    <div class='mesa-header'>
                        ...
                        <span class='cronometro' data-time='" . $row["tiempo_pedido"] . "'>00:00:00</span><!-- Aquí el temporizador -->
                    </div>
                    ...
                    </div>"; // Aquí se agregan los títulos
